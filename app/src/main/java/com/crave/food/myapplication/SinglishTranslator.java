            ...
            for(int i = 0; i < myText.length(); i++)
            {
                ...
                else if(value.equals("A"))
                {
                    ...
                    if(myText.length() > (i + 1))
                    {
                        ...
                        if(nextKeyValue.equals("a") || nextKeyValue.equals("A"))
                        {
                            returnText.append("ඈ");
                            myText.setCharAt(i + 1, ' ');
                        }
                ...
                else if(value.equals("N"))
                {
                    if(myText.length() > (i + 1))
                    {
                        ...
                        if(myText.length() > (i + 2))
                        {
                            ...
                            if (nextKeyValue.equals("a") && nextNextKeyValue.equals("a"))
                            {
                                returnText.append("ණා");
                                myText.setCharAt(i + 1, ' ');
                                myText.setCharAt(i + 2, ' ');
                            }
                            else if (nextKeyValue.equals("i") && nextNextKeyValue.equals("i"))
                            {
                                returnText.append("ණී");
                                myText.setCharAt(i + 1, ' ');
                                myText.setCharAt(i + 2, ' ');
                            }
                            else if (nextKeyValue.equals("e") && nextNextKeyValue.equals("e"))
                            {
                                returnText.append("ණේ");
                                myText.setCharAt(i + 1, ' ');
                                myText.setCharAt(i + 2, ' ');
                            }
                            else if (nextKeyValue.equals("o") && nextNextKeyValue.equals("o"))
                            {
                                returnText.append("ණෝ");
                                myText.setCharAt(i + 1, ' ');
                                myText.setCharAt(i + 2, ' ');
                            }
                            else if (nextKeyValue.equals("u") && nextNextKeyValue.equals("u"))
                            {
                                returnText.append("ණූ");
                                myText.setCharAt(i + 1, ' ');
                                myText.setCharAt(i + 2, ' ');
                            }
                            else if(nextKeyValue.equals("a"))
                            ...
                            {
                                returnText.append("ණි");
                                myText.setCharAt(i + 1, ' ');
                            }
                            else if(nextKeyValue.equals("e"))
                            {
                                returnText.append("ණෙ");
                                myText.setCharAt(i + 1, ' ');
                            }
                            else if(nextKeyValue.equals("o"))
                            {
                                returnText.append("ණො");
                                myText.setCharAt(i + 1, ' ');
                            }
                            else if(nextKeyValue.equals("u"))
                            {
                                returnText.append("ණු");
                                myText.setCharAt(i + 1, ' ');
                            }
                            else
                            {
                                returnText.append("ණ්");
                            }
                        }
                        else
                        {
                ...
                else if(value.equals("B"))
                {
                    if(myText.length() > (i + 2))
                    {
                        ...
                        if(nextKeyValue.equals("a") && nextNextKeyValue.equals("a"))
                        {
                            returnText.append("ඹා");
                            myText.setCharAt(i + 1, ' ');
                            myText.setCharAt(i + 2, ' ');
                        }
                        else if(nextKeyValue.equals("o") && nextNextKeyValue.equals("o"))
                        {
                            returnText.append("ඹෝ");
                            myText.setCharAt(i + 1, ' ');
                            myText.setCharAt(i + 2, ' ');
                        }
                        else if(nextKeyValue.equals("e") && nextNextKeyValue.equals("e"))
                        {
                            returnText.append("ඹේ");
                            myText.setCharAt(i + 1, ' ');
                            myText.setCharAt(i + 2, ' ');
                        }
                        else if(nextKeyValue.equals("u") && nextNextKeyValue.equals("u"))
                        {
                            returnText.append("ඹූ");
                            myText.setCharAt(i + 1, ' ');
                            myText.setCharAt(i + 2, ' ');
                        }
                        else if(nextKeyValue.equals("i") && nextNextKeyValue.equals("i"))
                        {
                            returnText.append("ඹී");
                            myText.setCharAt(i + 1, ' ');
                            myText.setCharAt(i + 2, ' ');
                        }
                        else if(nextKeyValue.equals("A") && nextNextKeyValue.equals("A"))
                        {
                            returnText.append("ඹෑ");
                            myText.setCharAt(i + 1, ' ');
                            myText.setCharAt(i + 2, ' ');
                        }
                        else if(nextKeyValue.equals("A") && nextNextKeyValue.equals("a"))
                        ...
                        {
                            returnText.append("ඹෙ");
                            myText.setCharAt(i + 1, ' ');
                        }
                        else if(nextKeyValue.equals("u"))
                        {
                            returnText.append("ඹු");
                            myText.setCharAt(i + 1, ' ');
                        }
                        else if(nextKeyValue.equals("i"))
                        {
                            returnText.append("ඹි");
                            myText.setCharAt(i + 1, ' ');
                        }
                        else if(nextKeyValue.equals("o"))
                        {
                            returnText.append("ඹො");
                            myText.setCharAt(i + 1, ' ');
                        }
                        else if(nextKeyValue.equals("A"))
                        {
                            returnText.append("ඹැ");
                            myText.setCharAt(i + 1, ' ');
                        }
                        else
                        {
                            returnText.append("ඹ්");
                        }

                    }
                    else if(myText.length() > (i + 1))
                    {
                        String nextKeyValue = Character.toString(myText.charAt(i + 1));
                ...
                else if(value.equals("L"))
                {
                    if(myText.length() > (i + 1))
                    {
                        ...
                        if(myText.length() > (i + 2))
                        {
                            ...
                            if (nextKeyValue.equals("a") && nextNextKeyValue.equals("a"))
                            {
                                returnText.append("ළා");
                                myText.setCharAt(i + 1, ' ');
                                myText.setCharAt(i + 2, ' ');
                            }
                            else if (nextKeyValue.equals("e") && nextNextKeyValue.equals("e"))
                            {
                                returnText.append("ළේ");
                                myText.setCharAt(i + 1, ' ');
                                myText.setCharAt(i + 2, ' ');
                            }
                            else if (nextKeyValue.equals("i") && nextNextKeyValue.equals("i"))
                            {
                                returnText.append("ළී");
                                myText.setCharAt(i + 1, ' ');
                                myText.setCharAt(i + 2, ' ');
                            }
                            else if (nextKeyValue.equals("A") && nextNextKeyValue.equals("A"))
                            {
                                returnText.append("ළෑ");
                                myText.setCharAt(i + 1, ' ');
                                myText.setCharAt(i + 2, ' ');
                            }
                            else if (nextKeyValue.equals("A") && nextNextKeyValue.equals("a"))
                            ...
                            {
                                returnText.append("ළෙ");
                                myText.setCharAt(i + 1, ' ');
                            }
                            else if(nextKeyValue.equals("i"))
                            {
                                returnText.append("ළි");
                                myText.setCharAt(i + 1, ' ');
                            }
                            else if(nextKeyValue.equals("A"))
                            {
                                returnText.append("ළැ");
                                myText.setCharAt(i + 1, ' ');
                            }
                            else
                            {
                                returnText.append("ළ්");
                            }
                        }
                        else
                        {
                ...
                else if(value.equals("w") || value.equals("v"))
                {
                    if(myText.length() > (i + 1))
                    {
                        String nextKeyValue = Character.toString(myText.charAt(i + 1));
                ...
                else if(value.equals("S"))
                {
                    if(myText.length() > (i + 1))
                    {
                        ...
                        if(myText.length() > (i + 3))
                        {
                            ...
                            {
                                returnText.append("ෂි");
                                myText.setCharAt(i + 1, ' ');
                                myText.setCharAt(i + 2, ' ');
                            }
                            else if (nextKeyValue.equals("h") && nextNextKeyValue.equals("e"))
                            {
                                returnText.append("ෂෙ");
                                myText.setCharAt(i + 1, ' ');
                                myText.setCharAt(i + 2, ' ');
                            }
                            else if (nextKeyValue.equals("i") && nextNextKeyValue.equals("i"))
